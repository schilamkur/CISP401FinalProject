...
//the universities file has been fixed to include all
//ivy league and UC schools, along with their correct GPA.

//added the printing of the collegeMatched string
...
public class Main {
    ...
    System.out.println("You're GPA is: " + studentGPA);
        ...
        this.collegeMatched();
        //final output has been printed - however all of the methods not done yet
